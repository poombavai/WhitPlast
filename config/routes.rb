...
get 'users/mould_history_xls'
  ...
  get 'users/report_color_agent_issue'
  post 'users/report_color_agent_issue'
  post 'users/color_agent_issue'

  get 'users/report_reground_usage'
  post 'users/report_reground_usage'
  post 'users/reground_usage'

  get 'users/report_finished_goods'
  post 'users/report_finished_goods'
  post 'users/finished_goods'

  get 'users/report_raw_material_usage'
  post 'users/report_raw_material_usage'
  post 'users/raw_material_usage'
  #post 'users/color_agent_issue'
